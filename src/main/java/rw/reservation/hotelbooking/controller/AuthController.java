package rw.reservation.hotelbooking.controller;

import jakarta.validation.Valid;
import rw.reservation.hotelbooking.dto.ResetPasswordDto;
import rw.reservation.hotelbooking.dto.UserDto;
import rw.reservation.hotelbooking.entity.User;
import rw.reservation.hotelbooking.repository.UserRepository;
import rw.reservation.hotelbooking.service.EmailService;
import rw.reservation.hotelbooking.service.UserService;
import rw.reservation.hotelbooking.service.UserServiceImpl;
        ...
        try {
            ...
            if (user == null) {
                ...
                context.setVariable("message",
                        "Reset your password by clicking the following http://localhost:8080/reset-password?email="
                                + user.getEmail());
